        ...
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-8">
            <div className="w-full bg-glass rounded-lg shadow md:mt-0 sm:max-w-md sl:p-8">
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <button type="button" className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg flex gap-2 p-2 items-center w-full text-center justify-center">
